...
async def cmd_start(message: Message):
    await message.answer('Привет, тебе нужна помощь с пониманием современных слэнговых слов? Я с удовольствием помогу тебе. Заинтересовало слово "скуф" в моем названии? Напиши мне его чтобы узнать его значение.')
